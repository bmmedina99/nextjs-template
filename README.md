...
Plantilla base para iniciar un nuevo proyecto con [Next.js](https://nextjs.org/), [TailwindCSS](https://tailwindcss.com/) y [TypeScript](https://www.typescriptlang.org/).

---

## Características

- **Next.js** v15.3 configurado para contenido dinámico.
